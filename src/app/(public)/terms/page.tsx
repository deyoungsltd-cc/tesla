...
const sections = [
  { title: '1. Acceptance of Terms', content: ['By accessing or using the TeslaPrime platform, you agree to be bound by these Terms of Service, our Privacy Policy, and all applicable laws and regulations. If you do not agree with any part of these terms, you must not use our platform. These terms apply to all users, including investors, visitors, and any other persons who access or use the service.'] },
  { title: '2. Eligibility', content: ['To use TeslaPrime, you must be at least 18 years of age (or the legal age of majority in your jurisdiction). You must have the legal capacity to enter into binding agreements. By creating an account, you represent and warrant that you meet these eligibility requirements.'] },
  { title: '3. Account Registration and Security', content: ['You are responsible for maintaining the confidentiality of your account credentials, including your email address, password, and any two-factor authentication codes. You must notify us immediately if you suspect unauthorized access to your account. TeslaPrime will never ask for your password via email, phone, or any other communication channel.'] },
  { title: '4. Investment Services', content: ['TeslaPrime provides investment management services through professionally managed plans. All investments involve risk, and past performance does not guarantee future results. The daily return rates advertised are targets based on historical performance and market conditions, and actual returns may vary. We reserve the right to modify plan parameters with reasonable notice.'] },
  ...
  { title: '7. Limitation of Liability', content: ['To the maximum extent permitted by law, TeslaPrime and its directors, employees, and affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the platform. Our total liability shall not exceed the total fees you have paid to us in the twelve months preceding the claim.'] },
  ...
  { title: '9. Contact', content: ['For questions about these Terms of Service, please contact us at teslaprimesupportt@gmail.com or through our support channels.'] },
];
