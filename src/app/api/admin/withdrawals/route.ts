      ...
      const result = await db.$transaction(async (tx) => {
        ...
        await tx.notification.create({
          data: {
            ...
            message: `Your withdrawal of $${formatMoney(withdrawal.amount)} has been approved and is being processed.`,
          },
        });
      ...
      const result = await db.$transaction(async (tx) => {
        ...
        await tx.notification.create({
          data: {
            ...
            message: `Your withdrawal of $${formatMoney(withdrawal.amount)} has been rejected. Reason: ${reason || 'Not specified'}. Funds returned to wallet.`,
          },
        });
