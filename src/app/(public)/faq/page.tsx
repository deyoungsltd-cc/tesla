      ...
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn>
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto leading-relaxed">Everything you need to know about investing with TeslaPrime. Can&apos;t find what you&apos;re looking for? <Link href="/contact" className="text-[#CC0000] hover:underline">Contact our support team</Link>.</p>
          </div>
        </FadeIn>
      </section>
