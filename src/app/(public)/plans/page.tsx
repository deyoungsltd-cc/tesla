        ...
        <FadeIn delay={150}>
          <div className="dash-card card-shine noise-overlay p-8 sm:p-10">
            <h2 className="text-white font-bold text-2xl mb-2 flex items-center gap-3">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#CC0000" strokeWidth="1.5"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
              ROI Preview
            </h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
              {plans.map((plan) => {
                ...
                return (
                  <div key={plan.name} className={`bg-[#1a1a1a] border rounded-2xl p-5 transition-all duration-300 hover:border-[#CC0000]/20 ${plan.popular ? 'border-[#CC0000]/30 shadow-[0_0_20px_rgba(204,0,0,0.1)]' : 'border-tesla-border'}`}>
          ...
          {plans.map((plan, idx) => {
            ...
            return (
              <FadeIn key={plan.name} delay={idx * 100}>
                <div className={`bg-tesla-card border-2 ${plan.color} rounded-2xl overflow-hidden card-shine noise-overlay transition-all duration-500 ${plan.popular ? 'shadow-[0_0_40px_rgba(204,0,0,0.1)]' : ''} hover:shadow-lg`}>
                  <div className="grid grid-cols-1 md:grid-cols-3">
                    <div className="relative h-56 md:h-auto overflow-hidden">
                      ...
                      {plan.popular && (
                        <>
                          ...
                          <div className="absolute bottom-4 left-4 right-4 bg-[#CC0000]/90 backdrop-blur-sm rounded-lg px-3 py-2 text-center">
                    ...
                    <div className="md:col-span-2 p-8 sm:p-10">
                      ...
                      <div className="flex flex-wrap gap-3 mb-8">
                        <div className="bg-[#1a1a1a] border border-tesla-border rounded-xl px-5 py-3">
        ...
        <FadeIn delay={100}>
          <div className="dash-card card-shine noise-overlay p-8 sm:p-10">
            <h3 className="text-white font-bold text-xl mb-4 flex items-center gap-3">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#CC0000" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
              Important Information
            </h3>
            <ul className="space-y-4 text-gray-400 text-sm leading-relaxed">
              <li className="flex items-start gap-3"><span className="text-[#CC0000] shrink-0 mt-1">&bull;</span> All plans guarantee full principal return at the end of the investment duration.</li>
              <li className="flex items-start gap-3"><span className="text-[#CC0000] shrink-0 mt-1">&bull;</span> Daily returns are automatically credited to your available balance every 24 hours.</li>
              <li className="flex items-start gap-3"><span className="text-[#CC0000] shrink-0 mt-1">&bull;</span> You may hold multiple active investments across different plans simultaneously.</li>
              <li className="flex items-start gap-3"><span className="text-[#CC0000] shrink-0 mt-1">&bull;</span> Past performance does not guarantee future results. Please read our <Link href="/risk-disclosure" className="text-[#CC0000] hover:underline font-medium">Risk Disclosure</Link> before investing.</li>
            </ul>
          </div>
        </FadeIn>
      </section>
        ...
        <FadeIn delay={200}>
          <div className="text-center">
            <div className="animated-border inline-block">
              <div className="dash-card card-shine noise-overlay bg-tesla-card rounded-2xl p-10">
