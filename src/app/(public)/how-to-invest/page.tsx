      ...
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn>
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto leading-relaxed">A complete guide to getting started with TeslaPrime and maximizing your investment returns.</p>
          </div>
        </FadeIn>
      </section>
