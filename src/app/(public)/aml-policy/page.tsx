...
const sections = [
  ...
  { title: '8. Staff Training', content: ['All TeslaPrime employees receive comprehensive AML/CTF training upon hiring and participate in ongoing training programs. Our compliance team receives advanced training in suspicious activity identification, investigation procedures, and regulatory reporting requirements.'] },
  { title: '9. Contact', content: ['For questions about our AML policies or to report suspicious activity, please contact our compliance department at teslaprimesupportt@gmail.com.'] },
];
