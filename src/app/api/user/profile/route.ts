...
async function putHandler(request: NextRequest, _context: any, user: any) {
  try {
    ...
    // Handle twoFactorEnabled separately (it's on the User model)
    ...
    return apiResponse({ ...profile, twoFactorEnabled: parsed.data.twoFactorEnabled });
  } catch (error) {
